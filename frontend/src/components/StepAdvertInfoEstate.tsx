...
import type { advertType } from "../types/Types";

interface Props {
    onNext: (data: Partial<advertType>, files: File[]) => void;
}
...
const StepAdvertInfoEstate = ({ onNext }: Props) => {
...
export default StepAdvertInfoEstate;